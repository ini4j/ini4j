...
public class Helper {
  ...
  public static final String DWARFS_REG_PATH =
      Reg.Hive.HKEY_CURRENT_USER + "\\Software\\ini4j-test";
  public static final float DELTA = 0.00000001f;
  private static final String[] CONFIG_PROPERTIES = {
    Config.PROP_EMPTY_OPTION,
    Config.PROP_GLOBAL_SECTION,
    Config.PROP_GLOBAL_SECTION_NAME,
    Config.PROP_INCLUDE,
    Config.PROP_LOWER_CASE_OPTION,
    Config.PROP_LOWER_CASE_SECTION,
    Config.PROP_MULTI_OPTION,
    Config.PROP_MULTI_SECTION,
    Config.PROP_STRICT_OPERATOR,
    Config.PROP_UNNAMED_SECTION,
    Config.PROP_ESCAPE,
    Config.PROP_ESCAPE_NEWLINE,
    Config.PROP_ESCAPE_KEY_ONLY,
    Config.PROP_PATH_SEPARATOR,
    Config.PROP_TREE,
    Config.PROP_PROPERTY_FIRST_UPPER,
    Config.PROP_FILE_ENCODING,
    Config.PROP_LINE_SEPARATOR,
    Config.PROP_COMMENT,
    Config.PROP_HEADER_COMMENT,
    Config.PROP_EMPTY_SECTION
  };
  private static final String[] FACTORY_PROPERTIES = {
    IniFormatter.class.getName(), IniParser.class.getName()
  };
