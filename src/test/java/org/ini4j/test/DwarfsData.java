...
public final class DwarfsData implements Dwarfs {
  ...
  static {
    ...
    bashful =
        new DwarfData(
            PROP_BASHFUL, 67, null, 98.8, "/home/bashful", "http://snowwhite.tale/~bashful", 45.7);
    doc =
        new DwarfData(
            PROP_DOC, 63, null, 87.7, "c:Documents and Settingsdoc", "http://doc.dwarfs", 49.5);
    dopey =
        new DwarfData(
            PROP_DOPEY,
            23,
            new int[] {11, 33, 55},
            doc.height,
            "c:\\Documents and Settings\\dopey",
            "http://dopey.snowwhite.tale/",
            bashful.weight);
    grumpy =
        new DwarfData(
            PROP_GRUMPY,
    ...
    sneezy =
        new DwarfData(
            ...
            76.88,
            "/home/sneezy",
            happy.homePage.toString() + "/~sneezy",
            69.7);
    dwarfs = new DwarfsData();
    dwarfNames =
        new String[] {
          bashful.name, doc.name, dopey.name, grumpy.name, happy.name, sleepy.name, sneezy.name
        };
  }
