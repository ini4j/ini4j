...
public class AbstractBeanInvocationHandlerTest extends Ini4jCase {
  ...
  public void testMisc() throws Exception {
    ...
    Dummy dummy =
        (Dummy)
            Proxy.newProxyInstance(getClass().getClassLoader(), new Class[] {Dummy.class}, handler);
    ...
    protected static <T> T newBean(Class<T> clazz, Map<String, String> map) {
      return clazz.cast(
          Proxy.newProxyInstance(
              clazz.getClassLoader(), new Class[] {clazz}, new MapBeanHandler(map)));
    }
