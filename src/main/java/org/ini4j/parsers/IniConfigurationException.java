...
public class IniConfigurationException extends IniParseException
{
     ...
     */
    public IniConfigurationException(String message)
    {
        super(message);
    }
     ...
     */
    public IniConfigurationException(Throwable cause)
    {
        super(cause);
    }
}
