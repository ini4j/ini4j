...
public class IniNotSupportedException extends IniConfigurationException
{
     ...
     */
    public IniNotSupportedException(String message)
    {
        super(message);
    }
     ...
     */
    public IniNotSupportedException(Throwable cause)
    {
        super(cause);
    }
}
