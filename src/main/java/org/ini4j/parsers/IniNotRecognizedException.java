...
public class IniNotRecognizedException extends IniConfigurationException
{
     ...
     */
    public IniNotRecognizedException(String message)
    {
        super(message);
    }
     ...
     */
    public IniNotRecognizedException(Throwable cause)
    {
        super(cause);
    }
}
